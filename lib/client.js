 ...
 * @param {Function} cb
 */
MsgBusClient.prototype.emailStats = function(fromTime, toTime, cb) {
 ...
 * @param {Function} cb
 */
MsgBusClient.prototype.emailStatsSince = function(msAgo, cb) {
	this.emailStats(Date.now() - msAgo, Date.now(), cb);
};
